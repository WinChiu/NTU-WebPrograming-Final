	  ...
	  */}
          ...
          >
            ...
            <Form.Item
              ...
              label="年級"
              wrapperCol={{ span: 400 }}
              rules={[{ required: true, message: "筆記年級不可為空" }]}
            >
            ...
            <Form.Item
              ...
              label="科目"
              wrapperCol={{ span: 400 }}
              rules={[{ required: true, message: "筆記科目不可為空" }]}
            >
            ...
            <Form.Item
              ...
              label="售價"
              wrapperCol={{ span: 400 }}
              rules={[{ required: true, message: "筆記售價不可為空且須不小於0" }]}
            >
              <InputNumber
                min={0}
                onChange={(value) => {
            ...
            <Form.Item
              name="介紹一下你的筆記吧"
              label="介紹一下你的筆記吧"
              rules={[{ required: true, message: "筆記介紹不可為空" }]}
            >
              <TextArea
                showCount
                placeholder={"在此描述你的筆記內容..."}
                maxLength={100}
            ...
            <Form.Item
              ...
              name="筆記檔案(請上傳PDF)"
              label="筆記檔案(請上傳PDF)"
              rules={[{ validator: validation, message: "筆記檔案不可為空 若已上傳請打勾" }]}
            >
              {
            ...
            <Form.Item label="是否提供試閱筆記">
              <Switch
                defaultChecked
                onChange={(checked) => {
                  if (checked) setPreview(true);
                  else setPreview(false);
                  setItem({ ...item, pdffile_preview: "" });
                }}
              />
              <Tooltip
                title="為了能夠讓大家更了解的你的筆記內容
